...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(shiftMass(task_6,3)));
    ...
    //task7
    public static int[] shiftMass(int[] mass,int n){
        int buff;
        for(int i=0;i<n;i++){
            for(int j=0; j<mass.length-1;j+=n){
                buff=mass[j+1];
                mass[j+1]=mass[i];
